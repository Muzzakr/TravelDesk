...
const PUBLIC_PATHS = ['/login', '/signup', '/api/auth', '/api/companies/signup', '/set-password', '/forgot-password', '/magic-link', '/sso/complete', '/api/contact', '/api/subscribe', '/api/unsubscribe', '/api/cron', '/api/webhooks']
